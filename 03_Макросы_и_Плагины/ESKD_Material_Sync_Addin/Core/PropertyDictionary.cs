...
namespace ESKD.MaterialSync.Core
{
    ...
    public sealed class PropertyDictionary
    {
        ...
        /// в окне «Проверить изделие»). В едином порядке свойств (№23) они последние среди известных — но перед своими
        /// свойствами конструктора и «Примечание», «Формат», «Раздел» (<see cref="PropertyOrder.Tail"/>): дописанное кнопкой
        /// в конец встаёт на место при следующем сохранении конструктором, один раз.
        /// </summary>
