...
DOCS["sa_task"] = dict(ROLE_COMMON, dir="05_Инструкции_по_ролям", md="Задание_сисадмину_права_КТО.md", pdf="Задание_сисадмину_права_КТО.pdf",
    kicker="Задание системному администратору · редакция 2", title="Права КТО на Synology",
    ...
    run="Задание сисадмину: права КТО", foot_r="15 сентября 2026 г.",
    cards=[("Сделать", "Группы, права по таблице, архив, снимки — около 40 минут"), ("Не делать", "Не включать в administrators, не делегировать"),
