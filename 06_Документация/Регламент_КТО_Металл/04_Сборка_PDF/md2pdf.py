...
DOCS["tz02"] = dict(
    ...
    org="ТОО «Троя» · Павлодар · Конструкторско-технологический отдел",
    kicker="Техническое задание · ТЗ-02 · редакция 1", title="Кнопки вкладки ЕСКД для работы по регламенту КТО",
    ...
    foot_l="Решения заказчика от 15.09.2026: реализуй — да; Покрытие — да; таблица изменений — да", foot_r="15 сентября 2026 г.", toc_depth=2,
    cards=[("Не меняется", "PropertyWriter, SyncService, BchService, правило «как MProp»; сторонних библиотек нет."),
           ("Битрикс24", "Не используется. История изменений — в папке изделия, Изменения.xlsx пишут кнопки."),
           ("Порядок", "Э0 спайки → Э1 словарь и форматки → Э2 каркас → К-1, К-2, К-3 → К-4, К-7, К-8 → К-5, К-6."),
