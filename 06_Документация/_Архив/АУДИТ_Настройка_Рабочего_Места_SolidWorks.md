...
> [!CAUTION]
> **Исторический документ** (31.08.2026). После аудита исходник конфигуратора переведён на общий модуль регистрации `Register-EskdAddin.ps1`, каталог форматок «База шаблонов» перенесён в архив. `Настройка_Рабочего_Места_SolidWorks.exe` из этих исходников не пересобран: решение D-5 о судьбе конфигуратора не принято. Установка рабочего места — `УСТАНОВИТЬ_ЕСКД.bat`, см. часть II в [руководстве](РУКОВОДСТВО_ПОЛЬЗОВАТЕЛЯ_И_АДМИНИСТРАТОРА.md).
