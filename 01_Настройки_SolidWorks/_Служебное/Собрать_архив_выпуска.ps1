...
КАК РАЗВЕРНУТЬ
  ...
  3. Запустите 01_Настройки_SolidWorks\Настройка_Рабочего_Места_SolidWorks.exe,
     впишите фамилию и организацию и нажмите «Установить / Обновить». Окно
     разложит шаблоны, форматки, библиотеки материалов, макросы SWPlus и
     надстройку ЕСКД, а затем проверит, что всё встало. Без кнопки окно
     ничего не запускает.
...
$notes = @("**Коммит:** ``$commit`` (ветка ``$branch``)", "",
           ...
           "2. Закройте SolidWorks.",
           "3. Запустите ``01_Настройки_SolidWorks\Настройка_Рабочего_Места_SolidWorks.exe`` и нажмите «Установить / Обновить».",
           "",
