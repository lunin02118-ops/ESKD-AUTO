...
.DESCRIPTION
    ...
    общей папки и нажимают «Установить / Обновить» (само окно ничего не запускает): шаблоны, форматки и библиотеки
    у всех обновляются сразу, макросы и надстройка — после нажатия кнопки.
...
Write-Host "Конструкторам: запустить $Target\01_Настройки_SolidWorks\Настройка_Рабочего_Места_SolidWorks.exe и нажать «Установить / Обновить»" -ForegroundColor Green
exit 0
