...
"""Правка DProp по дефекту Д-64 (решение владельца 19.09.2026 «сделать так, как правильно»).
    ...
    python 09_Тесты/tools/swplus_d64_edits.py            — пробная проверка
    python 09_Тесты/tools/swplus_d64_edits.py --apply    — архив прежнего .swp в 99_Архив/SWPlus_до_шага4, правка
