...
"""Правка MProp по замечанию владельца З-3 (18.09.2026): повторное заполнение после «Удалить все свойства».
    ...
    python 09_Тесты/tools/swplus_z3_edits.py            — пробная проверка
    python 09_Тесты/tools/swplus_z3_edits.py --apply    — архив прежнего .swp в 99_Архив/SWPlus_до_шага4, правка
