...
# Выпадающий список окна «Цвета покраски»; начальник КТО дописывает цвета, которые реально закупаются
COLORS = [
    ("RAL 9003", "Сигнальный белый"), ("RAL 9010", "Чистый белый"), ("RAL 9016", "Транспортный белый"),
    ("RAL 9005", "Глубокий чёрный"), ("RAL 7035", "Светло-серый"), ("RAL 7024", "Графитовый серый"),
    ("RAL 7040", "Серое окно"), ("RAL 5005", "Сигнальный синий"), ("RAL 5015", "Небесно-синий"),
    ("RAL 3020", "Транспортный красный"), ("RAL 1023", "Транспортный жёлтый"), ("RAL 6005", "Зелёный мох"),
    ("RAL 6018", "Жёлто-зелёный"), ("RAL 2004", "Чистый оранжевый"), ("RAL 8017", "Шоколадно-коричневый"),
]
SURFACES = ["глянец", "матовый", "шагрень", "муар"]
...
def norms_workbook():
    ...
    _table(wb.create_sheet("Цвета RAL"), ["RAL", "Название", "Поверхности", "Код 1С краски"],
           [(code, name, ", ".join(SURFACES), "") for code, name in COLORS], [12, 28, 34, 16])
    ...
    for r, text in enumerate([
        ...
        "«Цвета RAL»: выпадающий список цветов в окне «Цвета покраски»; добавляйте строки с нужными цветами, код 1С краски — для строки краски в комплектации.",
